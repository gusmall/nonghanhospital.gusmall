...
const menuItems = [
    ...
    { id: 'students', label: 'บริการประชาชน', icon: GraduationCap, path: '/admin/dashboard?tab=students' },
    { id: 'staff', label: 'บุคลากร', icon: Briefcase, path: '/admin/dashboard?tab=staff' },
